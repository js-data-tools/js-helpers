...
[@js-data-tools/js-helpers](../modules.md) / ignoreEmpty

# Function: ignoreEmpty()

> **ignoreEmpty**(`key`, `value`): `any`

Defined in: [serialize/normalize.ts:29](https://github.com/js-data-tools/js-helpers/blob/master/src/serialize/normalize.ts#L29)
