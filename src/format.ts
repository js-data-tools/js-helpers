 ...
 * @param {string[]} [unitNames] An optional list of unit names to use.
 ...
 * @since 1.0.0
 * @category format
 * @param {number} value The numerical value to format as a compact string.
 * @returns {string} A string with a compact version of the given number.
 * 
 * @example
 * 
